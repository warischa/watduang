...
⚠ Before generating an OG image · running a build · driving two headless probes at once · or putting a choice to the site owner → read `docs/runbook.md` first · verifying anything the way CI does, or reading CI's own verdict → `docs/agents/ci-verification.md` (`gh run list` 404s on this repo).

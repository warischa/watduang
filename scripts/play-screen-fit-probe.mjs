...
export const KNOWN_OVERFLOW = new Map([
  ...
  ['pinocchio-luck 320x568', 'owner ruling 2026-09-15: 136px on press 1 - 136px to scroll on documentElement, 4px clipped by div.css-mouth; measured 107-136px across 15 runs (13x107, 1x116, 1x120, 1x136) plus 107px on a 16th run 2026-09-03, a self-timed screen per the press-timing note in the file header. This row measures press 1, NOT the results screen: gh#195 measured that one separately at 244px document scroll with nothing clipping and the last control reachable, and the comment above records why this walk cannot reach it and what guards it instead. The binding requirement for a play screen is the 2026-09-10 rule — the primary control is reachable above the fold at 320px — not that the whole screen fits. This route was measured against that rule on 2026-09-11 and was not found in violation, so the remaining scroll is accepted rather than redesigned.'],
  ['pinocchio-luck 390x844', 'owner ruling 2026-09-15: 14px on press 1 - 14px to scroll on documentElement, 4px clipped by div.css-mouth. The binding requirement for a play screen is the 2026-09-10 rule — the primary control is reachable above the fold at 320px — not that the whole screen fits. This route was measured against that rule on 2026-09-11 and was not found in violation, so the remaining scroll is accepted rather than redesigned.'],
  ['pinocchio-luck 1440x900', 'owner ruling 2026-09-15: 17px on press 2 - 17px to scroll on documentElement, 4px clipped by div.css-mouth. The binding requirement for a play screen is the 2026-09-10 rule — the primary control is reachable above the fold at 320px — not that the whole screen fits. This route was measured against that rule on 2026-09-11 and was not found in violation, so the remaining scroll is accepted rather than redesigned.'],
  ...
  ['freeze-tap 320x568', 'owner ruling 2026-09-22: 12px on press 1 - 12px to scroll and 0px clipped on the pass screen. REPRODUCED on CI run 35687379298 attempts 1 and 2 of the same commit da75294, both reporting 12px at press 1 while presses 4, 5 and 6 read 0px. This row was in FITS_ROWS from an owner ruling 2026-09-15 whose evidence was 0px on three consecutive dev-machine runs; that instrument graded whichever of the nine TRIGGER_CONDITIONS an unseeded pick drew, and on a dev machine every draw reports the same numbers, so those three runs could not see the tall draw. gh#239 made the probe enumerate every draw and the tallest one overflows. This reason does not itself invoke the 2026-09-10 primary-control rule, and a first version of it wrongly said the fold had never been checked here. It has: on a Mac at c6e75ca, n=12 across both card states, playerReadyBtn reads 60 visible px on every load with the pass-screen container at 0 overflow, recorded under docs/verification/evidence/182-freeze-tap-fold-2026-09-15. MEASURED ON THE RUNNER 2026-09-22, CI run 35694044038, on the very draw that produces this 12px: draw index 7 of 9 won the worst-per-press merge and playerReadyBtn reads 72 visible px of 76, top 496 bottom 572. Partly visible, and the standing reading is that 0 visible px violates the 2026-09-10 rule while partly visible does not, so that rule IS satisfied here on the machine that produces the overflow. The same tree read 60 of 60 on a Mac, which also settles the re-measure 6dbaf71 left owing. This row therefore rests on the same basis as its sibling 320x568 rulings rather than on bare acceptance.'],
  ...
  ['zero-trigger 320x568', 'owner ruling 2026-09-15: 131px on press 0 - 131px to scroll on section#screen-game.screen.active. RE-RECORDED UPWARD from 96px, measured this run on this Mac: gh#194 deliberately gives the player strip its real height (flex-shrink:0 in overrides.css), and that height is added to a screen that was already over. The growth is the fix, not a regression — a chip row nobody can see is not a saving. Promotion to FITS_ROWS is not owed here; this row still overflows by design until the 320px play screen is redesigned. The binding requirement for a play screen is the 2026-09-10 rule — the primary control is reachable above the fold at 320px — not that the whole screen fits. This route was measured against that rule on 2026-09-11 and was not found in violation, so the remaining scroll is accepted rather than redesigned. This supersedes the preceding clause of this reason: after the 2026-09-15 ruling no redesign is owed here.'],

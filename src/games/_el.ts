...
// local to each game, because a test that imports two game modules would let one game's dispose()
// drain the other's pending listener removals through a shared mutable cleanup array.
